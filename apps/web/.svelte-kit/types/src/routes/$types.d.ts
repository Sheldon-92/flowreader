...
type LayoutRouteId = RouteId | "/" | "/auth/login" | "/auth/register" | "/design-system" | "/library" | "/notes" | "/notes/[id]" | "/notes/search" | "/read/[bookId]" | "/read/[bookId]/notes" | null
type LayoutParams = RouteParams & { id?: string; bookId?: string }
